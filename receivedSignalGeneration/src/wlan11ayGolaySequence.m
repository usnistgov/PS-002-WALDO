function [Ga,Gb] = wlan11ayGolaySequence(len, streamIdx)
%
%   [GA,GB] = wlan11ayGolaySequence(LEN, STREAMIDX) returns the Golay
...
assert(any(len==128),'wlan11ayGolaySequence: golay len not supported');
assert(any(streamIdx==1:8), 'wlan11ayGolaySequence: Invalid stream index');
